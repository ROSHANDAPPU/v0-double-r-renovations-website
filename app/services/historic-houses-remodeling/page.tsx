  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url('/elegant-1920s-craftsman-home-interior-woodwork.jpg')` }}
      >
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#1a1a1a] p-6">
                    <Image src="/prairie-style-home-restoration-living-room-firepla.jpg" alt="Project 1" width={400} height={300} className="w-full h-48 object-cover mb-4" />
                ...
                <div className="bg-[#1a1a1a] p-6">
                    <Image src="/tudor-revival-home-renovation-elegant-interior.jpg" alt="Project 2" width={400} height={300} className="w-full h-48 object-cover mb-4" />
                ...
                <div className="bg-[#1a1a1a] p-6">
                    <Image src="/victorian-home-interior-elegant-living-room-firepl.jpg" alt="Project 3" width={400} height={300} className="w-full h-48 object-cover mb-4" />
