  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url('/images/tudor-revival-home-renovation-elegant-interior.jpg')` }}
      >
        ...
        <section className="py-16">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="border border-[#C5B388] p-8">
              ...
              <p className="text-3xl font-bold text-[#C5B388]">$25k+</p>
            </div>
            <div className="border border-[#C5B388] p-8">
              <h3 className="text-sm uppercase tracking-[0.2em] text-[#CCCCCC] mb-3">Lead Time</h3>
              <p className="text-3xl font-bold text-[#C5B388]">3-6 Weeks</p>
            </div>
            <div className="border border-[#C5B388] p-8">
              <h3 className="text-sm uppercase tracking-[0.2em] text-[#CCCCCC] mb-3">Work On Site</h3>
              <p className="text-3xl font-bold text-[#C5B388]">1-3 Weeks</p>
            </div>
          </div>
        </section>
